...
if( !empty( $packages ) ) {
	...
	for( $j = 0; $j < count( $packages ) - 2; $j++ ) {
		...
		?>
		#ospt-design-wrapper.design-6 .ospt-box<?php echo '.box-color-' . $k;?> {
...
?>
#ospt-design-wrapper.design-6 .ospt-box.featured{
	background: <?php echo $featured_box_color;?>;
}
#ospt-design-wrapper.design-6 .ospt-box h3 {
	font-size: <?php echo $package_name_font;?>;
	color: <?php echo $package_name_box_color;?>;
}
#ospt-design-wrapper.design-6 .ospt-box ul li {
	font-size: <?php echo $features_font;?>;
	color: <?php echo $featured_font_color;?>;
}
#ospt-design-wrapper.design-6 .ospt-box .button_wrap a.hvr-shutter-out-vertical, .ospt_payment_box input.hvr-shutter-out-vertical {
	background-color: <?php echo $button_color;?>;
	color: <?php echo $font_color;?>;
}
#ospt-design-wrapper.design-6 .ospt-box .button_wrap a.hvr-shutter-out-vertical:before, .ospt_payment_box input.hvr-shutter-out-vertical:before {
	background: <?php echo $hover_color;?>;
}
#ospt-design-wrapper.design-6 .ospt-box .price_wrap span {
	font-size:<?php echo $price_font;?>;
	color: <?php echo $price_color;?>;
}
#ospt-design-wrapper.design-6 .ospt-box .price_wrap sup {
	color: <?php echo $price_color;?>;
}
.ospt_payment_box {
...
@media (min-width: 1190px) {
    #ospt-design-wrapper.design-6 .ospt-box {
        width: <?php echo ( 100/ absint( count( $packages ) - 1 ) ) - 2 ;?>%;
    }
}
@media (min-width:991px) and (max-width: 1190px) {
    #ospt-design-wrapper.design-6 .ospt-box {
        width: <?php echo ( 100/ absint( count( $packages ) - 2 ) ) - 2 ;?>%;
        margin-right: 20px;
    }
    #ospt-design-wrapper.design-6 .ospt-box:nth-child(3n) {
        margin-right: 0px;
    }
}
</style>
<div id="ospt-design-wrapper" class="design-6">
    <div class="row">
	<?php
    if( !empty( $packages ) ) {
        $i = $x = 0;
                ...
                <div class="col-xs-12 col-sm-6 col-md-<?php echo esc_attr( $column );?> col-lg-<?php echo esc_attr( $column );?> ospt-box <?php echo $class;?>">
                    <div class="top_wrap">
                        ...
                        <div class="price_outer">
                            <div class="price_wrap">
                                <?php echo $cny->ospt_get_currency_symbol( $currency );?>
                                <span><?php echo esc_attr( $price );?></span>
                                <sup>00</sup>
                            </div>
                        </div>
                        <?php if( $featured ){?><span class="featured-box"></span><?php } ?>
                    </div>
                    <div class="content_wrap">
                        ...
                        <div class="button_wrap">
                            ...
                            <a class="hvr-shutter-out-vertical" href="<?php echo esc_attr( $button_url );?>"><?php echo esc_attr( $button_text );?></a>
                            <?php 
                        } else { 
                            if( 'paypal' == $payment_method ) {
                            ?>
                            <form action="<?php echo esc_attr( $payment_url );?>" method="post" id="ospt_payment_form">
                                ...
                                <a class="hvr-shutter-out-vertical" onclick="document.getElementById( 'ospt_payment_form' ).submit();"><?php echo esc_attr( $button_text );?></a>
                            </form>
                            <?php 
                            } elseif( 'authorizenet-aim' == $payment_method || 'first-data' == $payment_method ) {
                            ?>
                            <a class="hvr-shutter-out-vertical ospt-colorbox" href="#ospt-payment-gateway-popup"><?php echo esc_attr( $button_text );?></a>
                            <div class="ospt-hide">
                                    ...
                                    <div class="ospt_payment_box">
                                        ...
                                        <form name="ospt_payment_form" id="ospt_payment_form" method="post">
                                            ...
                                            <fieldset id="ospt_authorizeaim-cc-form">
                                                ...
                                                <input type="submit"  value="Submit" id="ospt_submit" name="ospt_submit" class="hvr-shutter-out-vertical ospt_card_payment">                       
                                                <div class="clear"></div>
                                            </fieldset>
                                        </form>
