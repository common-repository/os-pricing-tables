...
$frgb = new osptColors( $featured_box_color, 1.1 );
$trgb = new osptColors( $featured_color, 1.1 );
?>
<style type="text/css">
<?php
if( !empty( $packages ) ) {
	...
	for( $j = 0; $j < count( $packages ) - 2; $j++ ) {
		...
		$rgb = new osptColors( $box_color, 1.1 );
		?>
		#ospt-design-wrapper .ospt-box<?php echo '.box-color-' . $k;?> .content_wrap{
			background: linear-gradient(to right bottom, #<?php echo $rgb->color;?> 50%, #<?php echo $rgb->shade;?> 50%);
			background: -o-linear-gradient(to right bottom, #<?php echo $rgb->color;?> 50%, #<?php echo $rgb->shade;?> 50%);
			background: -ms-linear-gradient(to right bottom, #<?php echo $rgb->color;?> 50%, #<?php echo $rgb->shade;?> 50%);
			background: -moz-linear-gradient(to right bottom, #<?php echo $rgb->color;?> 50%, #<?php echo $rgb->shade;?> 50%);
			background: -webkit-linear-gradient(to right bottom, #<?php echo $rgb->color;?> 50%, #<?php echo $rgb->shade;?> 50%);
		}
	<?php 
	}
}
?>
#ospt-design-wrapper .ospt-box.featured .content_wrap{
	background: linear-gradient(to right bottom, #<?php echo $frgb->color;?> 50%, #<?php echo $frgb->shade;?> 50%);
	background: -o-linear-gradient(to right bottom, #<?php echo $frgb->color;?> 50%, #<?php echo $frgb->shade;?> 50%);
	background: -ms-linear-gradient(to right bottom, #<?php echo $frgb->color;?> 50%, #<?php echo $frgb->shade;?> 50%);
	background: -moz-linear-gradient(to right bottom, #<?php echo $frgb->color;?> 50%, #<?php echo $frgb->shade;?> 50%);
	background: -webkit-linear-gradient(to right bottom, #<?php echo $frgb->color;?> 50%, #<?php echo $frgb->shade;?> 50%);
}
#ospt-design-wrapper.design-2 .ospt-box h3 {
	font-size: <?php echo $package_name_font;?>;
	color: <?php echo $package_name_box_color;?>;
}
#ospt-design-wrapper.design-2 .ospt-box ul li {
	font-size: <?php echo $features_font;?>;
	color: <?php echo $featured_font_color;?>;
}
#ospt-design-wrapper.design-2 .ospt-box .button_wrap a.hvr-ripple-out, .ospt_payment_box input.hvr-ripple-out {
	background-color: <?php echo $button_color;?>;
	color: <?php echo $font_color;?>;
	font-size:<?php echo $button_font;?>;
}
#ospt-design-wrapper.design-2 .ospt-box .button_wrap a.hvr-ripple-out:before, .ospt_payment_box input.hvr-ripple-out:before {
	border: <?php echo $button_color;?> solid 6px;
}
#ospt-design-wrapper.design-2 .ospt-box .price_wrap span {
	font-size:<?php echo $price_font;?>;
	color: <?php echo $price_color;?>;
}
#ospt-design-wrapper.design-2 .ospt-box h2 {
	background: linear-gradient(to right bottom, #<?php echo $trgb->color;?> 50%, #<?php echo $trgb->shade;?> 50%);
	background: -o-linear-gradient(to right bottom, #<?php echo $trgb->color;?> 50%, #<?php echo $trgb->shade;?> 50%);
	background: -ms-linear-gradient(to right bottom, #<?php echo $trgb->color;?> 50%, #<?php echo $trgb->shade;?> 50%);
	background: -moz-linear-gradient(to right bottom, #<?php echo $trgb->color;?> 50%, #<?php echo $trgb->shade;?> 50%);
	background: -webkit-linear-gradient(to right bottom, #<?php echo $trgb->color;?> 50%, #<?php echo $trgb->shade;?> 50%);
}
@media (min-width: 1190px) {
    #ospt-design-wrapper.design-2 .ospt-box {
        width: 31.333%;
    }
}
.ospt_payment_box {
...
<div id="ospt-design-wrapper" class="design-2">
    <div class="row">
	<?php
    if( !empty( $packages ) ) {
        $i = $x = 0;
                ...
                <div class="col-xs-12 col-sm-6 col-md-<?php echo esc_attr( $column );?> col-lg-<?php echo esc_attr( $column );?> ospt-box <?php echo $class;?>">
                    ...
                    <div class="content_wrap">
                        ...
                        <div class="button_wrap">
                            ...
                            <a class="hvr-ripple-out" href="<?php echo esc_attr( $button_url );?>"><?php echo esc_attr( $button_text );?></a>
                            <?php 
                    	} else { 
                        	if( 'paypal' == $payment_method ) {
                    		?>
	                        <form action="<?php echo esc_attr( $payment_url );?>" method="post" id="ospt_payment_form">
	                            ...
	                            <a class="hvr-ripple-out" onclick="document.getElementById( 'ospt_payment_form' ).submit();"><?php echo esc_attr( $button_text );?></a>
	                        </form>
                        	<?php 
                        	} elseif( 'authorizenet-aim' == $payment_method || 'first-data' == $payment_method ) {
                        	?>
                    		<a class="hvr-ripple-out ospt-colorbox" href="#ospt-payment-gateway-popup"><?php echo esc_attr( $button_text );?></a>
                    		<div class="ospt-hide">
									...
									<div class="ospt_payment_box">
										...
										<form name="ospt_payment_form" id="ospt_payment_form" method="post">
											...
											<fieldset id="ospt_authorizeaim-cc-form">
												...
												<input type="submit"  value="Submit" id="ospt_submit" name="ospt_submit" class="hvr-ripple-out ospt_card_payment">						
												<div class="clear"></div>
											</fieldset>
										</form>
