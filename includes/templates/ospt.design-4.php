...
if( !empty( $packages ) ) {
	...
	for( $j = 0; $j < count( $packages ) - 2; $j++ ) {
		...
		?>
		#ospt-design-wrapper.design-4 .ospt-box<?php echo '.box-color-' . $k;?> {
...
?>
#ospt-design-wrapper.design-4 .ospt-box.featured{
	background: <?php echo $featured_box_color;?>;
}
#ospt-design-wrapper.design-4 .ospt-box h3 {
	font-size: <?php echo $package_name_font;?>;
	color: <?php echo $package_name_box_color;?>;
}
#ospt-design-wrapper.design-4 .ospt-box ul li {
	font-size: <?php echo $features_font;?>;
	color: <?php echo $featured_font_color;?>;
}
#ospt-design-wrapper.design-4 .ospt-box .price_wrap {
	background-color: <?php echo $featured_color;?>;
}
#ospt-design-wrapper.design-4 .ospt-box .price_wrap span {
	font-size:<?php echo $price_font;?>;
	color: <?php echo $price_color;?>;
}
#ospt-design-wrapper.design-4 .ospt-box .price_wrap sup {
	color: <?php echo $price_color;?>;
}
#ospt-design-wrapper.design-4 .ospt-box .hvr-overline-from-center, .ospt_payment_box input.hvr-overline-from-center {
	background-color: <?php echo $button_color;?>;
	color: <?php echo $font_color;?>;
	font-size:<?php echo $button_font;?>;
}
#ospt-design-wrapper.design-4 .ospt-box .hvr-overline-from-center:before, .ospt_payment_box input.hvr-overline-from-center:before {
...
<div id="ospt-design-wrapper" class="design-4">
    <div class="row">
	<?php
    if( !empty( $packages ) ) {
        $i = $x = 0;
