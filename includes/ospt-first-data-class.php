...
class FirstData {
    ...
    protected $uri = OSWC_API_URL;

    protected $_uri = "/transaction/v12";

    /*Modify this acording to your firstdata api stuff*/
    protected $hmackey = OSWC_HMAC_KEY;
    protected $keyid = OSWC_KEY_ID;
    protected $gatewayid = OSWC_GATEWAY_ID;
    protected $password = OSWC_TERMINAL_PASSWORD;

    public $error = "";

    public $ModeDebug = OSWC_DEBUG;
